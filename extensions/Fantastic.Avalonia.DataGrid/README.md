## DataGrid for Fantastic.Avalonia
...
### How to use
- Add the `Fantastic.Avalonia.DataGrid` package to your project.
...
A full, working example is included in the [DataGridPage](https://github.com/bruisedsamurai/Fantastic.Avalonia/blob/main/samples/Gallery/Pages/DataGridPage.fs) sample
