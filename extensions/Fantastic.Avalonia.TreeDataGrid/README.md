## TreeDataGrid for Fantastic.Avalonia
...
### How to use
- Add the `Fantastic.Avalonia.TreeDataGrid` package to your project.
...
A full, working example is included in the [TreeDataGridPage](https://github.com/bruisedsamurai/Fantastic.Avalonia/blob/main/samples/Gallery/Pages/TreeDataGridPage.fs) sample
