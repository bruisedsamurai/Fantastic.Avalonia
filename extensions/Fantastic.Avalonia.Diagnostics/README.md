## Diagnostics for Fantastic.Avalonia
...
- Add the `Fantastic.Avalonia.Diagnostics` package to your project.
- Open `Fantastic.Avalonia` namespace at the top of the file where you declare your `SingleViewApplication` or `DesktopApplication` widgets.
