## ItemsRepeater for Fantastic.Avalonia
...
### How to use
- Add the `Fantastic.Avalonia.ItemsRepeater` package to your project.
...
A full, working example is included in the [ItemsRepeaterPage](https://github.com/bruisedsamurai/Fantastic.Avalonia/blob/main/samples/Gallery/Pages/ItemsRepeaterPage.fs) sample
